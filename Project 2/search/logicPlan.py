...
# Support Function for the next questuons 

def supp1(agent, KB, t, all_coords, non_outer_wall_coords, map):
    '''
...
def supp2(KB, t, coord, possible_loc):
    '''
...
def localization(problem, agent) -> Generator:
    ...
    for t in range(0, agent.num_timesteps):
        supp1(agent, KB, t, all_coords, non_outer_wall_coords, walls_grid)

        possible_loc = list()
        for wall in non_outer_wall_coords:
            supp2(KB, t, wall, possible_loc)
...
def mapping(problem, agent) -> Generator:
    ...
    for t in range(agent.num_timesteps):
        supp1(agent, KB, t, all_coords, non_outer_wall_coords, known_map)
        
        for wall in non_outer_wall_coords:
            supp3(KB, wall, known_map)
